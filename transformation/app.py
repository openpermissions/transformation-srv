...
"""Configures and starts up the Transformation Service.
"""
import os.path
...
from .controllers.root_handler import RootHandler
from .controllers.assets_handler import AssetsHandler
from .controllers.capabilities_handler import CapabilitiesHandler
...
APPLICATION_URLS = [
    (r"", RootHandler, {'version': __version__}),
...
def main():
    """
    The entry point for the Transformation service.
